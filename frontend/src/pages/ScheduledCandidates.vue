<script setup lang="ts">
    ...
    onMounted(() => candidateStore.statusWiseCandidateList('scheduled'))
            ...
            <div class="bg-white rounded">
                ...
                <table v-else class="w-full">
                    <thead class="bg-slate-50 border-b border-gray-100">
                        ...
                        <th class="text-left font-roboto px-4 py-2 text-gray-600">Scheduled At</th>
                    ...
                    <tbody>
                        <tr v-for="(candidate, index) in candidateStore.candidates" :key="candidate.id" :class="index % 2 !== 0 ? 'bg-slate-50' : ''">
                            ...
                            <td class="p-4 font-roboto text-gray-600 whitespace-nowrap">{{ candidate.scheduled_at?.human }}</td>
